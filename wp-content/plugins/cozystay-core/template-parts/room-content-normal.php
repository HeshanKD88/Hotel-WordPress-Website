<?php
    ...
    $has_gallery = $has_details && ( ( ! empty( $room_details[ 'gallery' ] ) ) || ( ! empty( $room_details[ 'listGallery' ] ) ) );
        ...
        if ( $has_featured_image_section ) :
            ...
            <div class="featured-img">
                ...
                if ( $show_gallery && $has_gallery ) : ?>
                    ...
                    $room_gallery = empty( $room_details[ 'listGallery' ] ) ? $room_details[ 'gallery' ] : $room_details[ 'listGallery' ];

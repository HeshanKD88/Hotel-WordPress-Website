	...
	class Core {
		...
		*/
		public function __construct() {
			...
			add_action( 'loftocean_jquery_ui', array( $this, 'jquery_ui_assets' ) );
		...
		* Jquery UI assets
		*/
		public function jquery_ui_assets() {
			wp_enqueue_style( 'jquery-ui', LOFTOCEAN_URI . 'assets/libs/jquery-ui/jquery-ui.min.css', array(), '1.11.4' );
			wp_enqueue_script( 'jquery-ui-datepicker' );
			function_exists( 'wp_localize_jquery_ui_datepicker' ) ? wp_localize_jquery_ui_datepicker() : '';
			
			// wp_enqueue_script( 'jquery-ui-i18n', LOFTOCEAN_URI . 'assets/libs/jquery-ui/jquery-ui-i18n.js', array( 'jquery', 'jquery-ui-datepicker' ), '1.13.2' );
			// wp_localize_script( 'jquery-ui-i18n', 'loftoceanjQueryUII18N', array(
			// 	'locale' => get_locale()
			// ) );
		}
		/**

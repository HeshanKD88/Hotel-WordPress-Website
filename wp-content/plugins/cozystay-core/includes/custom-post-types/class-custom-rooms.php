    ...
    class Room {
        ...
        */
        public function __construct() {
            ...
            require_once $dir . 'utils/class-woocommerce.php';
            ...
            require_once $dir . 'utils/ical/class-ical.php';
            require_once $dir . 'utils/ical/class-ical-sync.php';
            require_once $dir . 'utils/ical/class-ical-sync-cron.php';
            ...
            add_filter( 'loftocean_get_room_booking_data', array( $this, 'get_room_reservation_data' ), 10, 2 );
            add_filter( 'loftocean_room_reservation_message', array( $this, 'get_room_reservation_messages' ) );
        }
        /**
        ...
        */
        public function register_meta_boxes() {
            ...
            add_meta_box( 'loftocean-rooms-gallery', esc_html__( 'List Thumbnail Gallery (Optional)', 'loftocean' ), array( $this, 'meta_box_rooms_gallery' ), $this->post_type, 'side', 'default' );
            add_meta_box( 'loftocean-room-extra-link', esc_html__( 'Room External URL (Optional)', 'loftocean' ), array( $this, 'meta_box_room_url' ), $this->post_type, 'side', 'default' );
        ...
        */
        ...
        /*
        * Meta box rooms gallery
        */
        public function meta_box_rooms_gallery( $post ) {
            require_once LOFTOCEAN_DIR . 'includes/custom-post-types/rooms/view/meta/rooms-gallery.php';
        }
        /*
        * Meta box URL
        */
        public function meta_box_room_url( $post ) {
            require_once LOFTOCEAN_DIR . 'includes/custom-post-types/rooms/view/meta/url.php';
        }
        /*
        ...
        */
        public function save_room_metas( $post_id, $post, $update ) {
            ...
            if ( current_user_can( 'edit_post', $post_id ) ) {
                ...
                $rooms_gallery_ids = sanitize_text_field( wp_unslash( $_REQUEST[ 'loftocean_rooms_gallery_ids' ] ) );
                update_post_meta( $post_id, 'loftocean_rooms_gallery_ids', $rooms_gallery_ids );

                $room_url = sanitize_text_field( wp_unslash( $_REQUEST[ 'loftocean_room_url' ] ) );
                update_post_meta( $post_id, 'loftocean_room_url', $room_url );
        ...
        */
        public function enqueue_scripts() {
            ...
            if ( ! empty( $roomID ) && ( $this->post_type == get_post_type( $roomID ) ) ) {
                ...
                wp_localize_script( 'loftocean-room-reservation', 'loftoceanRoomReservation', apply_filters( 'loftocean_get_room_booking_data', array(), $roomID ) );
            }
        }
        /**
        ...
        */
        public function get_room_reservation_data( $data, $roomID ) {
            ...
            return array(
                ...
                'customVariablePrices' => get_post_meta( $roomID, 'loftocean_room_real_custom_variable_prices', true ),
        ...
        /*
        * Get room reservation messages
        */
        public function get_room_reservation_messages( $message ) {
            return array(

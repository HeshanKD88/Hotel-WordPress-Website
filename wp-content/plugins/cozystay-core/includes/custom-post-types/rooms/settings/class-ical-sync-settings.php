...
if ( ! class_exists( '\LoftOcean\Room\iCal_Sync_Settings' ) ) {
    class iCal_Sync_Settings {
        ...
        */
        ...
        /*
        * Ajax remove all imported bookings
        */
        protected $action_remove_all_bookings = 'loftocean_remove_all_imported_bookings';
        /*
        * capability
        */
        ...
        */
        public function __construct() {
            ...
            add_action( 'wp_ajax_' . $this->action_remove_all_bookings, array( $this, 'remove_all_imported_bookings' ) );
        }
        /**
        * Add submenu page
        */
        ...
        public function update_sync_source() {
            if ( isset( $_REQUEST, $_REQUEST[ 'data' ], $_REQUEST[ 'data' ][ 'titleBase64' ], $_REQUEST[ 'data' ][ 'urlBase64' ], $_REQUEST[ 'data' ][ 'roomID' ], $_REQUEST[ 'data' ][ 'oldURLBase64' ] )
                ...
                if ( ( ! empty( $old_url_base64 ) ) && ( $old_url_base64 != $url_base64 ) && isset( $sources[ $source_index ][ $old_url_base64 ] ) ) {
                    $this->remove_imported_bookings( $roomID, $old_url_base64 );
        ...
        */
        public function enqueue_assets() {
            ...
            wp_localize_script( 'loftocean-admin-ical-sync-settings', 'loftoceanRoomiCalSyncSettings', array(
                ...
                'actionRemoveAllBookings' => $this->action_remove_all_bookings,
        ...
        */
        ...
        /**
        * Remove all imported bookings
        */
        public function remove_all_imported_bookings() { 
            $bookings = apply_filters( 'loftocean_get_imported_bookings_by_args', array() );
            if ( \LoftOcean\is_valid_array( $bookings ) ) {
                foreach ( $bookings as $item ) {
                    wp_delete_post( $item, true );
                }
            }
            do_action( 'loftocean_cancel_room_all_imported_orders' );
        }
    }

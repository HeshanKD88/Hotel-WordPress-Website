    ...
    class Booking_Rules {
        ...
        */
        public function __construct() {
            ...
            add_filter( 'loftocean_get_all_rooms_booking_rules', array( $this, 'get_all_rooms_rules' ) );
                        ...
                        foreach ( $rules as $rule ) {
                            ...
                            if ( empty( $term_id ) ) {
                                ...
                                if ( ! is_wp_error( $new_term ) && \LoftOcean\is_valid_array( $new_term ) ) {
                                    ...
                                    update_term_meta( $new_term_id, 'apply_to_room_search_form', ( 'all' == $rule[ 'apply_to' ] ? $rule[ 'apply_to_room_search_form' ] : '' ) );
                                ...
                                update_term_meta( $term_id, 'apply_to_room_search_form', ( 'all' == $rule[ 'apply_to' ] ? $rule[ 'apply_to_room_search_form' ] : '' ) );
        ...
        */
        public function get_rules( $rules = array() ) {
            ...
            if ( ( ! is_wp_error( $terms ) ) && \LoftOcean\is_valid_array( $terms ) ) {
                return array_map( function( $item_id ) {
                    ...
                    $details[ 'apply_to_room_search_form' ] = isset( $details[ 'apply_to_room_search_form' ] ) ? $details[ 'apply_to_room_search_form' ] : '';
                    return $details;
                }, $terms );
            }
            return array();
        ...
        /*
        * Get rules for all rooms
        */
        public function get_all_rooms_rules( $rules ) {
            $terms = get_terms( array(
                'taxonomy' => $this->taxonomy,
                'hide_empty' => false,
                'orderby' => 'meta_value_num',
            ...
            return \LoftOcean\is_valid_array( $terms ) ? array_values( $terms ) : array();
        }
        /**

            ...
            if ( in_array( $order_status, $check_status ) ) {
                ...
                foreach ( $items as $item ) {
                    ...
                    if ( in_array( $room_id, $roomIDs ) ) {
                        $item_data = \LoftOcean\get_room_product_variation_data( $item->get_variation_id(), 'data' );
    ...
    */
    protected function get_uuid( $data, $item ) {
        if ( empty( $data[ 'uuid4' ] ) ) {
            ...
            \LoftOcean\update_room_product_variation_data( $item->get_variation_id(), $data, 'data' );
        }

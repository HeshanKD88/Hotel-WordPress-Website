	...
	class Availability {
		...
		*/
		public function __construct() {
			...
			add_action( 'loftocean_cancel_room_all_imported_orders', array( $this, 'cancel_all_imported_orders' ) );
		...
		*/
		...
		/*
		* Cancel all booking orders
		*/
		public function cancel_all_imported_orders() {
			global $wpdb;
			$order_table = $wpdb->prefix . $this->order_table;
			$wpdb->query( "UPDATE " . $order_table . " SET sync_from_other_platform = '';" );
		}
		/**
		* Decode a variable
		*/

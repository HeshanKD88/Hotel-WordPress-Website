                                ...
                                <ul><?php
                                    ...
                                    if ( 'on' == $details[ 'stay_length' ][ 'custom' ][ 'enable' ] ) : 
                                        ...
                                        foreach ( $weekdays as $index => $label ) {
                                            ...
                                            if ( \LoftOcean\is_valid_array( $content ) ) {
                                                array_push( $custom_stay_length, array( 'label' => $label, 'content' => $content ) );
                                            }
                                        }
                                        if ( \LoftOcean\is_valid_array( $custom_stay_length ) ) : ?>
                                            <li class="rule-single-item">
                                                ...
                                                <div class="rule-single-item-content">
                                                    <ul><?php
                                                    foreach ( $custom_stay_length as $csl ) : ?>
                                                        <li><?php echo $csl[ 'label' ]; ?>: <?php echo implode( ', ', $csl[ 'content' ] ); ?></li><?php
                                                    endforeach; ?>
                                                </ul>
                                                </div>
                                            </li><?php
                                    ...
                                    if ( ( 'on' == $details[ 'in_advance' ][ 'enable' ] ) && ( ( ! empty( $details[ 'in_advance' ][ 'min' ] ) ) || ( ! empty( $details[ 'in_advance' ][ 'max' ] ) ) ) ) : ?>
                                        <li class="rule-single-item">

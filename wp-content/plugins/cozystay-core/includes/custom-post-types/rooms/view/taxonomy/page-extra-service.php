...
<# data.list.forEach( function( item ) {
    ...
    <div class="loftocean-room-extra-service-item">
        ...
        <div class="loftocean-room-extra-service-controls-wrapper">
                ...
                <div class="control-wrapper custom-effective-time-slots-wrapper" data-slot-count="{{{ item.custom_effective_time_slots.length }}}" data-name-prefix="{{{ namePrefix }}}"<# if ( '' == item['effective_time'] ) { #> style="display: none;"<# } #>><#
                    if ( item.custom_effective_time_slots.length ) {
                        item.custom_effective_time_slots.forEach( function( cets, cets_index ) { #>
                            <div class="multi-items-wrapper">
                                <input name="{{{ namePrefix }}}[custom_effective_time_slot][{{{ cets_index }}}][start]" class="fullwidth date-picker" type="text" value="{{{ cets['start'] }}}" autocomplete="off" readonly>
                                <span class="field-text">-</span>
                                <input name="{{{ namePrefix }}}[custom_effective_time_slot][{{{ cets_index }}}][end]" class="fullwidth date-picker" type="text" value="{{{ cets['end'] }}}" autocomplete="off" readonly>
                        ...
                        <div class="multi-items-wrapper">
                            <input name="{{{ namePrefix }}}[custom_effective_time_slot][0][start]" class="fullwidth date-picker" type="text" value="" autocomplete="off" readonly>
                            <span class="field-text">-</span>
                            <input name="{{{ namePrefix }}}[custom_effective_time_slot][0][end]" class="fullwidth date-picker" type="text" value="" autocomplete="off" readonly>
                            <a href="#" class="add-custom-effective-time-slot"><?php esc_html_e( 'Add', 'loftocean' ); ?></a>
                            <a href="#" class="delete-custom-effective-time-slot"><?php esc_html_e( 'Delete', 'loftocean' ); ?></a>
                        </div><#
                    } #>
            ...
            <hr>
            <div class="controls-row">
                <div class="control-wrapper" class="extra-service-description-field" >
                    <label><?php esc_html_e( 'Description', 'loftocean' ); ?></label>
                    <textarea name="{{{ namePrefix }}}[description]">{{{ item[ 'description' ] }}}</textarea>
                </div>
            </div>
...
<script id="tmpl-loftocean-room-extra-service-custom-time-slot" type="text/template">
    <div class="multi-items-wrapper">
        <input name="{{{ data.namePrefix }}}[custom_effective_time_slot][{{{ data.index }}}][start]" class="fullwidth date-picker" type="text" value="" autocomplete="off" readonly>
        <span class="field-text">-</span>
        <input name="{{{ data.namePrefix }}}[custom_effective_time_slot][{{{ data.index }}}][end]" class="fullwidth date-picker" type="text" value="" autocomplete="off" readonly>
        <a href="#" class="add-custom-effective-time-slot"><?php esc_html_e( 'Add', 'loftocean' ); ?></a>
        <a href="#" class="delete-custom-effective-time-slot"><?php esc_html_e( 'Delete', 'loftocean' ); ?></a>
    </div>
</script

        ...
        <div class="loftocean-room-rules-controls-wrapper">
            <div class="controls-row">
                ...
                <div class="control-wrapper loftocean-custom-date-range<# if ( '' == item[ 'time_range' ] ) { #> hide<# } #>">
                    ...
                    <div class="multi-items-wrapper">
                        <input name="{{{ namePrefix }}}[start_date]" class="fullwidth date-picker" type="text" value="{{{ item[ 'start_date' ] }}}"<# if ( 'custom' == item[ 'time_range' ] ) { #> required<# } #> autocomplete="off" readonly>
                        <span class="field-text">-</span>
                        <input name="{{{ namePrefix }}}[end_date]" class="fullwidth date-picker" type="text" value="{{{ item[ 'end_date' ] }}}"<# if ( 'custom' == item[ 'time_range' ] ) { #> required<# } #> autocomplete="off" readonly>
                    </div>
                </div>
            </div>
            <hr>
                ...
                <div class="control-wrapper">
                    ...
                    if ( $has_room_types ) : ?>
                        <div class="loftocean-room_types sub-options<# if ( 'room_types' != item[ 'apply_to' ] ) { #> hide <# } #>">
                            <select name="{{{ namePrefix }}}[apply_to_room_types][]" multiple class="multiple-choices" data-placeholder="<?php esc_attr_e( 'Click to choose room types', 'loftocean' ); ?>"><?php
                    ...
                    if ( $has_rooms ) : ?>
                        <div class="loftocean-rooms sub-options<# if ( 'rooms' != item[ 'apply_to' ] ) { #> hide <# } #>">
                            <select name="{{{ namePrefix }}}[apply_to_rooms][]" multiple class="multiple-choices" data-placeholder="<?php esc_attr_e( 'Click to choose rooms', 'loftocean' ); ?>"><?php
                    ...
                    <div class="loftocean-all apply-to-room-search-form sub-options<# if ( 'all' != item[ 'apply_to' ] ) { #> hide <# } #>">
                        <div class="option-title-with-toggle">
                            <input type="checkbox" name="{{{ namePrefix }}}[apply_to_room_search_form]" id="{{{ labelID }}}-apply-to-room-search-form" value="on"<# if ( 'on' == item[ 'apply_to_room_search_form' ] ) { #> checked<# } #>>
                            <label for="{{{ labelID }}}-apply-to-room-search-form"><?php esc_html_e( 'Show this rule-set on all room search forms?', 'loftocean' ); ?></label>
                        </div>
                    </div>
                </div>
            </div>

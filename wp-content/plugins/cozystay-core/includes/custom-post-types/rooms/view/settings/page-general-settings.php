<div class="wrap">
    ...
    <div class="setting-content-container"><?php
        ...
        $titles = array( 'guests' => esc_html__( 'Guests', 'loftocean' ), 'search-results' => esc_html__( 'Search Results', 'loftocean' ), 'advanced' => esc_html__( 'Advanced', 'loftocean' ) ); 
        ...
        <form id="room-advanced-settings" method="POST" action="<?php echo esc_url( admin_url( 'edit.php?post_type=loftocean_room&page=loftocean_room_general_settings' ) ); ?>">
            ...
            <div class="cs-tab-content-wrapper<?php if ( 'search-results' != $current_active_tab ) : ?> hidden<?php endif; ?>" id="tab-search-results-content">
                <table class="form-table">
                    <tbody>
                        <tr class="loftocean-room-regenerate-orders">
                            <th><?php esc_html_e( 'Room Search', 'loftocean' ); ?></th>
                            <td><?php
                                $skip_search_results_page = get_option( 'loftocean_skip_room_search_results_page', '' ); ?>
                                <input type="checkbox" name="loftocean_skip_room_search_results_page" id="loftocean-skip-room-search-results-page" value="on" <?php checked( 'on', $skip_search_results_page ); ?>>
                                <label class="description" for="loftocean-skip-room-search-results-page"><?php esc_html_e( 'Skip room search results page when only one search result is found.', 'loftocean' ); ?></label>
                            </td>
                        </tr>
                    </tbody>
                </table>

            ...
            <div class="loftocean-modal-content">
                ...
                <p>
                    <input 
                        ...
                        value="<?php esc_attr_e( 'Add Calendar', 'loftocean' ); ?>"
                        data-default-value="<?php esc_attr_e( 'Add Calendar', 'loftocean' ); ?>"
                        data-edit-value="<?php esc_attr_e( 'Delete Old Data and Save', 'loftocean' ); ?>" 
                        data-label="<?php esc_attr_e( 'Add Calendar', 'loftocean' ); ?>" 
                        data-update-text="<?php esc_attr_e( 'Updating ...', 'loftocean' ); ?>"
                    >

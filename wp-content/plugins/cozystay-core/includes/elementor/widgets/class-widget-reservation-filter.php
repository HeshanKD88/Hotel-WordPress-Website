	...
	*/
	...
	protected function register_controls() {
        ...
        $this->add_control( 'item_check_in', array(
            ...
            'type' => 'loftocean-switcher-control', // \Elementor\Controls_Manager::SWITCHER,
            'default' => 'on',
            'label_on' => 'on',
            'label_off' => 'off',
            'return_value' => 'on',
		...
		$this->add_control( 'custom_panel_notice', array(
			'type' => \Elementor\Controls_Manager::NOTICE,
			'notice_type' => 'info',
			'dismissible' => false,
			'heading' => esc_html__( 'Please Note', 'loftocean' ),
			'content' => esc_html__( 'Check in and check out cannot be disabled.', 'loftocean' ),
            'separator' => 'after'
		) );

...
final class Elementor_Extension {
	...
	public function init_extension() {
		if ( $this->is_compatible() ) {
			...
			do_action( 'loftocean_init_elementor' );
		}
	}
	/**
	...
	public function init() {
		...
		add_action( 'elementor/frontend/before_enqueue_scripts', array( $this, 'fix_swiper_missed' ) );
	...
	*/
	private function get_controls() {
		return array(
			array( 'type' => 'loftocean-switcher-control', 'class' => '\LoftOcean\Elementor\Control\Control_Switcher', 'file' => 'class-switcher-control.php' )
		);
	}
	/**
	...
	*/
	public function enqueue_frontend_assets() {
		...
		wp_enqueue_script( 
			'loftocean-elementor-frontend', 
			LOFTOCEAN_ASSETS_URI . 'scripts/front/elementor.min.js', 
			array( 'jquery-daterangepicker', 'elementor-frontend', 'loftocean-parallax-bundle', 'loftocean-base64', 'loftocean_room_reservation_utils' ), 
	...
	*/
	...
	/*
	* Fix swiper missing issue in version 3.26
	*/
	public function fix_swiper_missed() { 

( function( $ ) {
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		if ( $roomSearchForm.length ) {
			var dateFormat = $roomSearchForm.data( 'date-format' ) ? $roomSearchForm.data( 'date-format' ) : 'YYYY-MM-DD', datePickerArgs = {},
			...
			if ( ( 'undefined' !== typeof loftoceanDatePickerValidate ) 
                ...
                datePickerArgs[ 'beforeShowDay' ] = function( date, drp ) {
                    return loftoceanDatePickerValidate.checkDate( date, drp );
                }

            }

			$dateRangePicker.daterangepicker( datePickerArgs ).on( 'apply.daterangepicker', function( e, drp ) {
